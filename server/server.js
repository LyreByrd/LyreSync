...
const privateKey = fs.readFileSync('sudo ../../../etc/letsencrypt/live/gamaycotte.com/privkey.pem').toString();
const certificate = fs.readFileSync('sudo ../../../etc/letsencrypt/live/gamaycotte.com/fullchain.pem').toString();
